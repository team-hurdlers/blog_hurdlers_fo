  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 z-50 lg:left-[240px] left-6 w-12 h-12 bg-gray-700 hover:bg-gray-600 text-white rounded-full shadow-lg transition-all duration-300 flex items-center justify-center"
        aria-label="카테고리 메뉴"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      {showScrollToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 z-50 lg:right-[300px] right-6 w-12 h-12 bg-black hover:bg-gray-800 text-white rounded-full shadow-lg transition-all duration-300 flex items-center justify-center"
          aria-label="맨 위로 스크롤"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      {showCategoryMenu && (
        <>
          ...
          {/* 카테고리 메뉴 */}
          <div className="fixed z-50 bg-white rounded-lg shadow-xl border border-gray-200 bottom-20 lg:left-[240px] left-6 w-56">
            <div className="p-4">
