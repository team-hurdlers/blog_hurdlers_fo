    ...
    <footer className="bg-white py-5 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative text-center py-20 mb-16 overflow-hidden" style={{
          ...
          <Link
            href="https://hurdlers.kr/about/contact"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-600">
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/ai/ai-data-analysis" 
                  className="hover:text-gray-900 transition-colors"
                >
                  AI 데이터 분석
                </Link>
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/ai/ai-automation" 
                  className="hover:text-gray-900 transition-colors"
                >
                  AI 자동화 구축
                </Link>
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/ai/ai-contents" 
                  className="hover:text-gray-900 transition-colors"
                >
                  AI 생성형 컨텐츠
                </Link>
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/data/ga4-consulting" 
                  className="hover:text-gray-900 transition-colors"
                >
                  GA4 구축
                </Link>
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/data/integrated-dashboard" 
                  className="hover:text-gray-900 transition-colors"
                >
                  통합 대시보드 구축
                </Link>
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/marketing/martech-onboarding" 
                  className="hover:text-gray-900 transition-colors"
                >
                  마테크 온보딩
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-600 mt-6">
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/develop/web-app" 
                  className="hover:text-gray-900 transition-colors"
                >
                  Web/App 개발
                </Link>
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/marketing/growth-marketing" 
                  className="hover:text-gray-900 transition-colors"
                >
                  그로스 마케팅
                </Link>
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/marketing/search-ad" 
                  className="hover:text-gray-900 transition-colors"
                >
                  검색 광고 자동화
                </Link>
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/marketing/seo-aeo" 
                  className="hover:text-gray-900 transition-colors"
                >
                  SEO/AEO
                </Link>
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/service/data/martech-maintenance" 
                  className="hover:text-gray-900 transition-colors"
                >
                  마테크 유지보수
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-600">
              ...
              <li>
                <Link 
                  href="https://hurdlers.kr/about/recruit" 
                  className="hover:text-gray-900 transition-colors"
                >
                  채용
                </Link>
