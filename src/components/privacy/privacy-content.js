export default function PrivacyContent() {
  return (
    <div className="privacy-content text-gray-800">
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제1조(목적)</h2>
        <p className="mb-4">
          허들러스(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제2조(개인정보 처리의 원칙)</h2>
        <p className="mb-4">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제3조(본 방침의 공개)</h2>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제4조(본 방침의 변경)</h2>
        <ol className="list-decimal pl-6 space-y-2">
          <li>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>선택 수집 정보: 이름, 전화번호</li>
        </ul>
      </section>

      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제6조(기타 수집 정보)</h2>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제7조(개인정보 수집 방법)</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            이용자가 뉴스레터 구독, 서비스 문의 등 회사의 서비스를 이용하는
            과정에서 이용자가 입력하는 방식
          </li>
        </ul>
      </section>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제8조(개인정보의 이용)</h2>
        <p className="mb-4">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제9조(개인정보의 처리 위탁)</h2>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            스티비에게 뉴스레터 발송를 위하여 구독해지시 혹은 위탁 계약
            종료시까지 동안 개인정보처리를 위탁함
          </li>
        </ul>
      </section>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제12조(개인정보의 파기원칙)</h2>
        <p className="mb-4">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제13조(개인정보파기절차)</h2>
        <ol className="list-decimal pl-6 space-y-2">
          <li>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제14조(개인정보파기방법)</h2>
        <p className="mb-4">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제16조(아동의 개인정보보호)</h2>
        <ol className="list-decimal pl-6 space-y-2">
          <li>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">제17조(이용자의 의무)</h2>
        <ol className="list-decimal pl-6 space-y-2">
          <li>
      ...
      <section className="mb-10">
        ...
        <div className="bg-gray-50 p-4 rounded-md">
          <h3 className="font-semibold mb-2">개인정보 보호 책임자</h3>
          <ul className="space-y-1">
            <li>성명: 유준혁</li>
            <li>직책: CTO</li>
            <li>전화번호: 010-7183-5248</li>
            <li>이메일: fix_yoo@hurdlers.kr</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="mb-4">제1조 본 방침은 2025.03.28.부터 시행됩니다.</p>
      </section>
    </div>
  )
}
